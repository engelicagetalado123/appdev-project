            ...
            <aside class="drawer" id="drawer">
                ...
                <nav class="menu-list-container">
                    <ul class="menu-links">
                        ...
                        <li onclick="window.location.href='cert_request.php'"><i class="fas fa-file-contract"></i> Request Certificate</li>
                        <li onclick="window.location.href='feedback.php'"><i class="fas fa-comments"></i> Residence Feedback</li>
                        <li onclick="window.location.href='meeting_request.php'"><i class="fas fa-handshake"></i> Meeting Request</li>
